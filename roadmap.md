...
- [ ] Simplify Payroll: remove gross-to-date, deployed counts, attendance status, and per-unit payroll totals; keep name, contract ID, and right-aligned Payroll Open.
