...
- [ ] Match Guard and non-billable employee dashboards to the Field Officer bento layout.
- [ ] Preserve attendance, assignments, manager, team, device, and insights behavior.
- [ ] Verify responsive layout and project checks.
