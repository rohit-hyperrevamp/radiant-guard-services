-- Pass 2 of the L&T 26 -> 27 present-day correction.
-- Remaining cases carry their extra duty on days that already hold a code
-- (double shift on a present day). For those, one extra-duty day is absorbed by
-- marking a non-present, unpaid day (Absent, or Weekly Off without pay) as
-- Present and decrementing one extra-duty day.
