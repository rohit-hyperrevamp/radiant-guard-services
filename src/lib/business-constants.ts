...
/**
 * "No Man's Land" holding client. Used to onboard guards when no client
 * client is yet assigned; reassigned to a real client within a week.
 */
export const NOMANS_UNIT_CODE = "NOMANS";

/** UUID of the "No Man's Land" holding client. */
export const NOMANS_UNIT_ID = "045fc1ec-a703-494f-8cce-29d353374c60";

/** True when the client is the No Man's Land holding unit (by id or code). */
